...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note/flexsearch.min.js');loadScript('/note/en.search-data.min.af1a6ddf12a92a9183166d6854375a51bccb592798ca9de1b3759347e82dbaf6.js',function(){input.required=false;search();});}
