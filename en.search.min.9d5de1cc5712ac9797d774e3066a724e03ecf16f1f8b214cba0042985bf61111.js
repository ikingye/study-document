...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-document/flexsearch.min.js');loadScript('/study-document/en.search-data.min.249963e02cf0cd9fadb371a49728fa9ace34aaafc71ea44b4448411c89699676.js',function(){input.required=false;search();});}
