...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-document/flexsearch.min.js');loadScript('/study-document/en.search-data.min.50c68cc417ed1e0aaac3d33a3a276f9e4372bd105e8832e60cd5033070a24676.js',function(){input.required=false;search();});}
