...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-document/flexsearch.min.js');loadScript('/study-document/en.search-data.min.280bdb6aa6cee2a3b65052b1ac1e5821a6383db9ee0b4297bd46992154d4bbad.js',function(){input.required=false;search();});}
