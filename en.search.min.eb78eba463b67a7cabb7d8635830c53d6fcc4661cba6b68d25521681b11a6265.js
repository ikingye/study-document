...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-document/flexsearch.min.js');loadScript('/study-document/en.search-data.min.c822bdbdd9f56d4a9dcbdd2289255daa160043f6803464def5652f7b41a5ecc5.js',function(){input.required=false;search();});}
