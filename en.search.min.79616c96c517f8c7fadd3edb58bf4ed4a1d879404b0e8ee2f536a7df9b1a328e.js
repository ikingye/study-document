...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-document/flexsearch.min.js');loadScript('/study-document/en.search-data.min.d3b5e8bf121250a8214200a4e71c2945706572cef04f428d7ed46a4a32a4597c.js',function(){input.required=false;search();});}
